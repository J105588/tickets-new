...
BEGIN
  ...
  IF p_id IS NOT NULL THEN
    INSERT INTO bookings (
      id, performance_id, name, email, grade_class, club_affiliation, passcode, status, created_at
    ) VALUES (
      p_id, v_perf_id, p_name, p_email, p_grade_class, p_club_affiliation, v_passcode, 'confirmed', NOW()
