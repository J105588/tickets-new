...
const sidebarHTML = `
  <div id="sidebar-panel" class="sidebar">
    ...
    <div class="navigation-section">
      ...
      <a href="javascript:void(0)" onclick="navigateToReleaseNotes()" class="nav-link" id="release-notes-nav-link">リリースノート</a>
    </div>
...
function navigateToReleaseNotes() {
    window.location.href = '../pages/release-notes.html';
}
...
window.navigateToReleaseNotes = navigateToReleaseNotes;
